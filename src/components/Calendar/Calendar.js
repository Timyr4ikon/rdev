...
import {setCurrentMonth} from '../../redux/actions/index'
...
class Calendar extends Component {
  ...
  componentDidMount() {
    this.props.setMonth(this.props.month.format('MMMM'))
  ...
  previous() {
    ...
    this.props.setMonth(moment(this.state.month).subtract(1, 'month').format('MMMM'))
  }
  ...
  next() {
    ...
    this.props.setMonth(moment(this.state.month).add(1, 'month').format('MMMM'))
  }
  ...
  render() {
    ...
    const format = dayOfWeekFormat &&
                    dayOfWeekFormat !== '' &&
                    moment(today, dayOfWeekFormat).isValid() ? dayOfWeekFormat : 'd'
    ...
    return (
      <table className={classes}>
        ...
        <tfoot className="tfoot">
          ...
          <th className="DayOfWeek">S</th>
          <th className="DayOfWeek">M</th>
          <th className="DayOfWeek">T</th>
          <th className="DayOfWeek">W</th>
          <th className="DayOfWeek">T</th>
          <th className="DayOfWeek">F</th>
          <th className="DayOfWeek">S</th>
          </tr>
        </tfoot>
...
const mapDispatchToProps = dispatch => {
  return {
    setMonth: (x) => dispatch(setCurrentMonth(x))
  }
}
